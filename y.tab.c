...
static const yytype_uint8 yyrline[] =
{
     ...
     177,   188,   190,   196,   202,   204,   205,   206,   213,   214,
     216,   217,   219,   220,   221,   222,   224,   225,   226,   228,
     229,   231,   232,   239,   242,   243
};
#endif
...
#line 109 "6.y"
                                  {
									...
									instList[nextInst()]="goto "+itoa((yyvsp[-5].node)->instNum);
...
#line 167 "6.y"
					...
					instList[nextInst()]=(yyval.node)->addr+" = "+(yyvsp[-1].node)->addr+" * "+itoa(getWidth((yyval.node)->type));
				}
#line 1717 "y.tab.c"
    break;
...
#line 178 "6.y"
		 			...
		 			instList[nextInst()]=myTemp->addr + " = "+(yyvsp[-1].node)->addr +" * "+itoa(getWidth((yyval.node)->type));
